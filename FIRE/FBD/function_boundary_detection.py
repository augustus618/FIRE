...
def function_boundary_detection(binary_full_path, pred_scores):
    ...
    funcs_boundary, call_graph, removed_time = detect_func(instruction_sequence, basic_blocks, pc_to_instruction_index,
                                                           ...
                                                           pred_scores, config.current_threshold,
    ...
    return funcs_boundary_ret, start_pcs, instruction_sequence, end_time
